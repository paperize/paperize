...
export function renderItemToSVG(game, component, template, item, options) {
    ...
    const context = options.renderTarget.nested()
    context.move(
...
function renderTextLayerToSVG (game, component, template, item, layer, options) {
    const context = options.renderTarget.nested()
}

function renderImageLayerToSVG(game, component, template, item, layer, options) {
    const context = options.renderTarget.nested()
}

function renderShapeLayerToSVG(game, component, template, item, layer, options) {
    const context = options.renderTarget.nested()
}