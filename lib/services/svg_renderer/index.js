...
export async function svgToPNG(svg, options) {
    return _svgToRasterImage(svg, {...options, imageFormat: RASTER_IMAGE_PNG_TYPE})
}

export async function svgToJPG(svg, options) {
    return _svgToRasterImage(svg, {...options, imageFormat: RASTER_IMAGE_JPG_TYPE})
}
