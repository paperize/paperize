...
const getClient = async tryUsingClient => {
  ...
  try {
    ...
    // TODO: store access token here if needed for picker, etc
...
export default { loginPromise, getClient, registerSignInListener, isSignedIn, getCurrentUser, getAccessToken, signIn, signOut, revokeAccess }
export { loginPromise, getClient, registerSignInListener, isSignedIn, getCurrentUser, getAccessToken, signIn, signOut, revokeAccess }
