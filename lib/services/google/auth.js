...
const
  ...
  SCOPES = [
    ...
    // Paperize can create files/folders in Drive, can only edit files/folders it created
    "https://www.googleapis.com/auth/drive.file",

    // Unfettered access to Drive and Sheets ::cringe::
    // "https://www.googleapis.com/auth/drive",
    // "https://www.googleapis.com/auth/spreadsheets"
  ].join(" ")

// Remember how to only load google script tag once user
// has signaled they want to invite google to the party
