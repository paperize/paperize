...
import { renderComponentToPNG, renderComponentToSVG, renderComponentToJPG } from '../svg_renderer'

const publicApi = {
  renderItemToPdf(game, component, item, template) {

    renderComponentToJPG(game, component, template, item)
    .then((imgs) => console.log(imgs[0].src))
